<template>
    <div class="drag">
        ...
        <div v-else class="row">
            <div class="col-md-12" style="display:flex;flex-wrap:wrap;justifycontent:center">
                <div class="card" style="width: 18rem;margin:6px" v-for="prod in Articles" :key="prod.id">
                    ...
                    <div class="card-body">
                        ...
                        <div style="text-align:center">
                            ...
                            <button class="btn btn-outline-primary" @click="addToCart(prod)" v-if="prod.qtestock > 1">Add
                                to Cart</button>
